...
export default function Layout({ children }) {
  return <>
    ...
    <span style={{ fontSize: "90%", textAlign: "center", color: "gray", display: "table", margin: "4rem" + " auto", padding: "0 0.5rem 20px 0.5rem" }}>Copyright &#169; 2022 TrackTask STM, All Rights Reserved - <Link href="/privacy" legacyBehavior><a className="footer">Privacy</a></Link> - <Link href="/terms" legacyBehavior><a className="footer">Terms of Use</a></Link></span>
  </>;
}
