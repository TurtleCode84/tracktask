...
export default function UserAdmin() {
  ...
  return (
    <Layout>
      ...
      <p>Last modified: {lookup.history.lastEdit.timestamp > 0 ? <span title={moment.unix(lookup.history.lastEdit.timestamp).format("dddd, MMMM Do YYYY, h:mm:ss a")}>{lookup.history.lastEdit.timestamp} by <User user={user} id={lookup.history.lastEdit.by}/></span> : 'never'}</p>
