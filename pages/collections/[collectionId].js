...
export default function Collection() {
  ...
  return (
    <Layout>
      <h2>{collection?.sharing.shared ? <span title="Shared" style={{ color: "lightslategray" }} className="material-symbols-outlined">group</span> : <span title="Private" style={{ color: "lightslategray" }} className="material-symbols-outlined">person</span>}{' '}{collection ? <>{collection.name}:</> : 'Loading...'}</h2>
