...
export default function Account() {
  ...
  return (
    <Layout>
      ...
      {!user.permissions.verified && <p style={{ fontStyle: "italic", color: "var(--secondary-text-color)" }}>Your email is not verified, <Link href="/dashboard/account/verify">click here to verify</Link>.</p>}
