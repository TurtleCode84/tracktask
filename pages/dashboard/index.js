...
export default function Dashboard() {
  ...
  return (
    <Layout>
      ...
      <>
      {upcomingTasksError ? <p style={{ fontStyle: "italic" }}>{upcomingTasksError}</p> : <p style={{ fontStyle: "italic" }}>Loading tasks...</p>}
      </>
      :
      ...
      <>
      {recentTasksError ? <p style={{ fontStyle: "italic" }}>{recentTasksError}</p> : <p style={{ fontStyle: "italic" }}>Loading tasks...</p>}
      </>
      :
      <><ul style={{ display: "table" }}>
        {recentTaskList}
      ...
      <>
      {collectionsError ? <p style={{ fontStyle: "italic" }}>{collectionsError}</p> : <p style={{ fontStyle: "italic" }}>Loading collections...</p>}
      </>
      :
      <><ul style={{ display: "table" }}>
        {collectionList}
